...
label end_peremena1:
    ...
    $ renpy.call_screen("scr_achievement_get", title="Голодные игры", a_text="И пусть удача всегда будет с вами!", icon="bg/GERB.png")

    scene black_back with fade
    pause 1.0

    # Подпись: "Глава 2"
    show text "Глава 4" at truecenter with dissolve
    pause 2.0
