...
image smirnov = Transform("characters/smirnov_small.png", zoom = 1.2)
image p = Transform("characters/small_polina.png", zoom = 1.2)
image p_deb = Transform("characters/small_polina_deb.png", zoom = 1.2)
image lesha = "characters/lexa.png"
...
label chapter5_quiz:
    ...
    if ans3 == define_strict3:
        ...
        smir "…Интересно.{w=0.5} Такое ощущение,{w=0.3} что ты знаешь больше,{w=0.3} чем нужно..." (what_slow_cps=15)
